        ...
        try {
            ...
            for (int i =0; i < Encoded_Compressed_String_FileArray.size(); i++){
                ...
                if (i < stagesize){
                    ...
                    out.println(SecurityMechanisms.AES_Encrypt(Encoded_Compressed_String_FileArray.get(i),SECRET_KEY,256));
                    //out.println(SecurityMechanisms.RC4Encrypt(Encoded_Compressed_String_FileArray.get(i),SECRET_KEY_RC4.getBytes()));
                    //out.println(SecurityMechanisms.BF_encrypt(Encoded_Compressed_String_FileArray.get(i),SECRET_KEY));
                    System.out.println("Encrypted Message "+i+" sent......");
                    ...
                    out.println(SecurityMechanisms.AES_Encrypt(Encoded_Compressed_String_FileArray.get(i),SECRET_KEY,128));
                    //out.println(SecurityMechanisms.RC4Encrypt(Encoded_Compressed_String_FileArray.get(i),SECRET_KEY_RC4.getBytes()));
                    //out.println(SecurityMechanisms.BF_encrypt(Encoded_Compressed_String_FileArray.get(i),SECRET_KEY));
                    System.out.println("Encrypted Message "+i+" sent......");
        ...
        try{
            ...
            while (true){
                ...
                if (Message.startsWith("FINISH")){
                  ...
                  Received_Encrypted_FileArray.add(Message);
            ...
            for (int i =0; i < Received_Encrypted_FileArray.size(); i++) {
                ...
                if(i < stagesize){
                    ...
                    Received_Decrypted_FileArray.add(SecurityMechanisms.AES_Decrypt(Received_Encrypted_FileArray.get(i),SECRET_KEY,256));
                    //Received_Decrypted_FileArray.add(SecurityMechanisms.RC4Decrypt(Received_Encrypted_FileArray.get(i),SECRET_KEY_RC4.getBytes()));
                    //Received_Decrypted_FileArray.add(SecurityMechanisms.BF_decrypt(Received_Encrypted_FileArray.get(i),SECRET_KEY));
                    //DecryptedEncodedFile.concat(SecurityMechanisms.AES_Decrypt(Received_Encrypted_FileArray.get(i).toString(),SECRET_KEY,AES_Key_Length));
                    ...
                    Received_Decrypted_FileArray.add(SecurityMechanisms.AES_Decrypt(Received_Encrypted_FileArray.get(i),SECRET_KEY,128));
                    //Received_Decrypted_FileArray.add(SecurityMechanisms.RC4Decrypt(Received_Encrypted_FileArray.get(i),SECRET_KEY_RC4.getBytes()));
                    //Received_Decrypted_FileArray.add(SecurityMechanisms.BF_decrypt(Received_Encrypted_FileArray.get(i),SECRET_KEY));
                    //DecryptedEncodedFile.concat(SecurityMechanisms.AES_Decrypt(Received_Encrypted_FileArray.get(i).toString(),SECRET_KEY,AES_Key_Length));
